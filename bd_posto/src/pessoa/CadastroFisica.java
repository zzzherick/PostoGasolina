...
public class CadastroFisica extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CadastroFisica frame = new CadastroFisica();
			...
			public void actionPerformed(ActionEvent e) {
		        ...
		        if(senha.equals(confirmaSenha)) {
		        	if(!nome.equals("")) {
			        	...
			        	Fisica pessoaFisica = new Fisica(login, senha, nome, email, telefone, cpf);
				        ...
				        try {
							Banco.inserirPessoaFisica(pessoaFisica);
